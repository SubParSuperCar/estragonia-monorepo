...
public static class ConversionExtensions
{
    ...
    {
        return s_keyMap.GetValueOrDefault(source, AvKey.None);
    }

    public static PhysicalKey ToAvaloniaPhysicalKey(this GdKey source)
    {
        return s_physicalKeyMap.GetValueOrDefault(source, PhysicalKey.None);
    }
    ...
    {
        return s_cursorMap.GetValueOrDefault(source, GdCursorShape.Arrow);
    }
}
